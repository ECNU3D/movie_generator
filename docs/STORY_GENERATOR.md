...
| **可灵 3.0 对白模式** | 多镜头叙事+角色对白，@角色名 引用主体，最长15秒，音画同步 |
...
| **对白模式 (3.0)** | 可灵 3.0 多镜头对白模式提示词 |

### 可灵 3.0 对白模式

可灵 3.0 Omni 支持原生多镜头叙事和音画同步，特别适合生成带角色对白的视频。
...
**使用方式**:
1. **单镜头对白**: 在生成提示词页面勾选"启用对白模式"
2. **多镜头对白**: 在分镜编辑页面使用"可灵 3.0 多镜头对白模式"功能，选择要合并的镜头范围
...
- **2026-02-07**:
  ...
  - 单镜头对白提示词生成
  - 多镜头对白合并生成（分镜页面）
  - 新增 `platform_guide_kling_dialogue` 模板
- **2026-01-25**:
  - 新增 Admin 系统管理功能
  - 新增 API 调用日志追踪（查看请求、响应、延迟）
  - 新增提示词模板配置（支持版本历史管理）
  - 支持按平台定制提示词风格指南
- **2026-01-24**:
  - 新增人物数量自定义功能
